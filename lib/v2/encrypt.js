...
function v2Encrypt(payload, key, _a) {
    if (_a === void 0) { _a = {}; }
    var footer = _a.footer, nonce = _a.nonce, options = __rest(_a, ["footer", "nonce"]);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    nonce = _b.sent();
                    _b.label = 2;
                case 2: return [4 /*yield*/, crypto_worker_main_1.crypto_worker_main['xchacha20-poly1305-encrypt'](m, nonce, k, f)];
                case 3:
                    d = _b.sent();
                    return [2 /*return*/, pack_1.pack(h, [d.n, d.c], f)];
            }
        });
    });
}
exports.v2Encrypt = v2Encrypt;
