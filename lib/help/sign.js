        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    m2 = pae_1.pae(h, m, f);
                    return [4 /*yield*/, crypto_worker_main_1.crypto_worker_main.sign(alg, m2, key)];
                case 1:
                    sig = _a.sent();
                    if (sig.length !== expectedSigLength) {
                        throw new TypeError("invalid " + h.slice(0, -1) + " signing key bit length");
                    }
                    return [2 /*return*/, pack_1.pack(h, [m, sig], f)];
            }
        });
    });
}
exports.signPaseto = signPaseto;
