            ...
            switch (_e.label) {
                case 0:
                    ...
                    if (token.substr(0, h.length) !== h) {
                        throw new errors_1.PasetoInvalid('token is not a v1.local PASETO');
                    }
                    ...
                    k = key["export"]();
                    return [4 /*yield*/, crypto_worker_main_1.crypto_worker_main['aes-256-ctr-hmac-sha-384-decrypt'](raw, f, k)];
                case 1:
                    payload = _e.sent();
                    if (!payload) {
                    ...
                    if (complete) {
                        return [2 /*return*/, { payload: payload, footer: f.length ? f : undefined, version: 'v1', purpose: 'local' }];
                    }
