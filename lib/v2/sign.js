...
function checkKey(key) {
    if (!(key instanceof crypto_1.KeyObject)) {
        key = crypto_1.createPrivateKey(key);
    }
...
function v2Sign(payload, key, _a) {
    if (_a === void 0) { _a = {}; }
    var footer = _a.footer, options = __rest(_a, ["footer"]);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sign_1.signPaseto('v2.public.', payload, f, undefined, checkKey(key), 64)];
                case 1: return [2 /*return*/, _b.sent()];
            }
        });
    });
}
exports.v2Sign = v2Sign;
